const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_BULBASAUR] = _("POOŁILONKA"),
    [SPECIES_IVYSAUR] = _("POOŁICHOBA"),
    [SPECIES_VENUSAUR] = _("POOŁIMIKKO"),
    [SPECIES_CHARMANDER] = _("CHAAMANTA"),
    [SPECIES_CHARMELEON] = _("CHAAMIILO"),
    [SPECIES_CHARIZARD] = _("LISAADO"),
    [SPECIES_SQUIRTLE] = _("SKOYTA"),
    [SPECIES_WARTORTLE] = _("WAATOYTA"),
    [SPECIES_BLASTOISE] = _("BLASTOYTA"),
    [SPECIES_CATERPIE] = _("KAATAAPI"),
