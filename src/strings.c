...
const u8 gText_EggNickname[] = _("ACHOSKI");
...
const u8 gText_Boy[] = _("NAANI");
const u8 gText_Girl[] = _("TAYYI");
...
const u8 gText_YesNo[] = _("EY\nINKOBI");
const u8 gText_GoBackToThePreviousMenu[] = _("Go back to the\nprevious menu.");
const u8 gText_WhatWouldYouLikeToDo[] = _("Naason nahayk chibanna?");
...
const u8 gText_PartyMenu_OK[] = _("HOW");
...
const u8 gText_TurnOff[] = _("ATIPASLI");
const u8 gText_Decoration[] = _("もようがえ");
const u8 gText_ItemStorage[] = _("NAASCHIKIIKA");
const u8 gText_Mailbox[] = _("HOLISSO IMIISA");
...
const u8 gText_Yes[] = _("EY");
const u8 gText_No[] = _("INKOBI");
...
const u8 gText_YourName[] = _("CHIHOLCHIFA?");
const u8 gText_BoxName[] = _("BOX NAME?");
const u8 gText_PkmnsNickname[] = _("'s nickname?");
const u8 gText_RivalsName[] = _("ACHAAPA HOLCHIFA?");
